...
//           <Text
//             style={[styles.subtotalstyle, { flexShrink: 1, maxWidth: wp('40%') },]} numberOfLines={2} ellipsizeMode="tail">
//             Subtotal:
//           </Text>
//           <Text
//             style={[styles.subtotalstyle, { flexShrink: 1, maxWidth: wp('40%'), color: Colors.primary },]} numberOfLines={2} ellipsizeMode="tail">
//             Rs 4,979,988
//           </Text>
//         </View>
//         <Btn
