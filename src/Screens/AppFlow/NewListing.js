        ...
        <SafeAreaView style={MyStyling.container}>
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: hp(5) }}>
                ...
                <View style={{ marginTop: hp(1) }}>
                    <RequestFormInputs title={'Brand '} secondTitle={'Model'} icon={Images.brand} secondIcon={Images.model} placeholder={'Enter Brand'} secondPlaceholder={'Enter Model'} mainView={{ marginTop: hp(1.5) }} />
                    <RequestFormInputs title={'Storage Capacity '} secondTitle={'RAM Capacity'} icon={Images.brand} secondIcon={Images.model} placeholder={'Storage'} secondPlaceholder={'RAM Capacity'} mainView={{ marginTop: hp(1.5) }} />
                    <Text style={styles.titleText}>{Strings.priceRange}</Text>
                    <CustomInputText inputContainer={styles.inputContainer} placeholder={'Enter Price'} />
